...
Run from project root:
    ...
    python evaluation/runEval.py --auto-corpus --target 150
    python evaluation/runEval.py --corpus mails/corpus.json --no-ablation
"""

import os, sys, argparse
from pathlib import Path

# Add evaluation/ to path so local imports (datasetCreator, evaluationFramework) work
